...
class resultpro extends StatefulWidget {
  final int id;
  ...
  const resultpro({Key key, this.id}) : super(key: key);

  @override
  _resultproState createState() => _resultproState();
}

class _resultproState extends State<resultpro> {
  Future getdata() async{
    var url="https://tpowep.com/mob/catresultpro.php?id=Nokia";
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            ...
                                            TextSpan(text:"  resultpro22",style: TextStyle(fontSize: 15,color: Colors.amberAccent),),
                                          ],
                                        ),
                                      )
                                  ),
                                  ...
                                  child: Container(
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            TextSpan(text:"الموديل",style: TextStyle(fontSize: 15,color: Colors.black),),
                                            TextSpan(text:"  resultpro22",style: TextStyle(fontSize: 15,color: Colors.deepOrange),),
                                          ],
                                        ),
                                      )
                                  ),
