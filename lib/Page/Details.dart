                      ...
                      child: Container(
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(text:"المعالج  ",style: TextStyle(fontSize: 20,color: Colors.black),),
                                TextSpan(text:widget.poss,style: TextStyle(fontSize: 20,color: Colors.amberAccent),),
                              ],
                            ),
                          )
                      ),
                      ...
                      child: Container(
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(text:"الذاكرة  ",style: TextStyle(fontSize: 20,color: Colors.black),),
                                TextSpan(text:widget.ram,style: TextStyle(fontSize: 20,color: Colors.deepOrange),),
                              ],
                            ),
                          )
                      ),
                      ...
                      child: Container(                          width: MediaQuery.of(context).size.width,
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(text:" الكاميرا",style: TextStyle(fontSize: 20,color: Colors.black),),
                                TextSpan(text:widget.cam,style: TextStyle(fontSize: 20,color: Colors.amberAccent),),
                              ],
                            ),
                          )
                      ),
